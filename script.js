document.addEventListener('DOMContentLoaded', () => {
    ...
    const scenarios = [
        ...
        },
        {
            ...
            story: "Uma diligência de imóvel crucial está travada. Faltam certidões que o vendedor diz serem 'difíceis de conseguir' e ele sugere 'deixar assim' e assinar com uma ressalva. O cliente interno (Comercial) está com pressa.",
            task: "Como o time deve atuar nesse cenário de 'deixar assim'?",
            feedback: "Aqui, o <strong>Aim high</strong> (lp2) nos desafia a não aceitar o 'status quo'. Devemos usar o <strong>Dive deep</strong> (lp4) para entender *por que* é difícil e buscar alternativas (outras fontes, dados públicos). Isso tudo é para <strong>Delight Customers</strong> (lp1), entregando a segurança e confiança que eles esperam de nós, e não apenas uma 'ressalva' que transfere o risco.",
            ...
            footerElements: '<div class="footer-item footer-item-1"><img src="mario.gif" alt="Mario-correndo"></div><div class="footer-item footer-item-2"><img src="pipe.png" alt="Cano"></div>',
            groundImage: 'cubo-3.png' // Chão do Nível 2
        },
        {
            id: 2,
            title: "Nível 3: A Falha",
            story: "Um analista comete um erro numa diligência que gera retrabalho e DSAT. Ele está visivelmente desmotivado e com medo de ser punido. O time todo percebeu.",
        ...
        },
        {
            ...
            story: "Durante uma análise de rotina, você nota um pequeno erro formal em uma certidão antiga. Corrigir isso vai exigir contato com o cartório e atrasará a entrega em um dia. Ninguém notou, e 'passaria batido'.",
            task: "Você gasta tempo corrigindo o pequeno erro ou entrega no prazo?",
            feedback: "Essa é a essência do <strong>Make it great</strong> (lp6). Líderes se recusam a baixar a qualidade para 'tirar a tarefa da frente'. Embora pareça pequeno, <strong>Do what is right</strong> (lp8) exige precisão, pois o 'jeitinho' (mesmo pequeno) compromete a confiança. A melhor ação é corrigir, alinhando a expectativa do atraso com o time.",
        ...
        },
        {
            ...
            story: "Um cliente liga para o Legal Front, muito irritado. Ele não entende por que a diligência está 'demorando tanto' e acusa o time de 'burocracia'. A comunicação está difícil e ele está sendo rude.",
            task: "Como o time de atendimento deve lidar com esse cliente?",
            feedback: "Situação difícil! É a hora de <strong>Delight Customers</strong> (lp1) não com o que ele *quer* (pressa), mas com o que ele *precisa* (clareza e segurança). Isso exige <strong>Dive deep</strong> (lp4) para entender a real dor dele (ansiedade?) e <strong>Enjoy the ride</strong> (lp7), que significa liderar com empatia e manter a energia positiva, mesmo em momentos ruins, para desarmar o conflito.",
